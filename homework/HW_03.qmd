...
```{r}
knitr::opts_knit$set(root.dir = "C:\\Users\\jgluckman\\OneDrive - RAND Corporation\\Desktop\\Machine Learning\\\\PRGS-Intro-to-ML-2025\\")
pacman::p_load("tidyverse", "sf")
svi <- read.csv("data\\raw\\SVI Updated.csv")
svi_raw <- svi
```
...
us <- st_read("data\\raw\\tl_2019_us_county")
...
Also, it is worth noting that I excluded all US territories, Alaska, and Hawaii from the choropleth in order to keep images visible. Connecticut is also missing as an artifact of the source of the data.
